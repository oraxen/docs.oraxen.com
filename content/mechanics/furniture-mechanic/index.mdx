...
See the [clickAction mechanic](/mechanics/all-mechanics/clickaction-mechanic) for detailed configuration.
...
See [farming mechanic](./farming-mechanic) for detailed plant/evolution configuration.
