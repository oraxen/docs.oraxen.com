...
### Click Actions
Run commands, play sounds, or send messages when a player clicks the block.\
...
Look into one of the WorldGenerator plugins in [World Generators](/compatibility/world-generators) for that.\
