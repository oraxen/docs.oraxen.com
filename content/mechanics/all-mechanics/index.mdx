...
On 1.20.5+ use the new [Food-Component](../../configuration/items-advanced/README#1205-specific-properties) instead
...
On 1.21+ use the new [JukeboxPlayable-Component](../../configuration/items-advanced/README#121-specific-properties) instead
...
On 1.20.5+ use the new [Durability-Component](../../configuration/items-advanced/README#1205-specific-properties) instead
...
On 1.20.5+ use the new [FireResistant-Component](../../configuration/items-advanced/README#1205-specific-properties) instead of burns_in_X below
On 1.21.2+ use the new [DamageResistant-Component](../../configuration/items-advanced/README#1212-specific-properties) instead of burns_in_X/breaks_from_cactus below
...
This mechanic allows you to run various events when a player clicks a block or furniture. It is very customizable, so it also has a [dedicated tutorial page](clickaction-mechanic).
...
This mechanic allows you to customize events, conditions and actions. Since it is a quite rspecial mechanic, it has its [dedicated tutorial page](custom-mechanic).
