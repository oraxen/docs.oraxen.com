...
1. **CommandAPI** - Download the version-specific CommandAPI for your server:
   - For **Spigot**: Download from [CommandAPI releases](https://github.com/JorelAli/CommandAPI/releases)
   - For **Paper**: Download from [CommandAPI releases](https://github.com/JorelAli/CommandAPI/releases) (Paper version)
   - For more details, see the [CommandAPI installation guide](https://docs.commandapi.dev/user-setup/install)

2. Drop the Oraxen and CommandAPI .jar files into your `/plugins/` folder.
...
Oraxen has been tested with Spigot and Paper 1.18 -> 1.21.11


For Minecraft 1.21.2+, using the latest version of Oraxen is advised. Oraxen is developed and designed for use with [Paper](https://mcserverjars.com/paper) or [Spigot](https://mcserverjars.com/spigot) server software. Download server jars from [MCServerJars.com](https://mcserverjars.com). For older Minecraft versions, start by installing Oraxen 1.183.0 to get compatible configuration files. You can then update the jar file accordingly.
