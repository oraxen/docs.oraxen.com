...
**next_stage** you specify the next stage, it has to be an already created Oraxen item.

**farmblock_required** [dedicated tutorial page](../noteblock-mechanic/farmblock-mechanic)
