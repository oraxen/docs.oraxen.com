...
**How it works:**
- `reveal` is a counter that increases over time
- When `reveal > charIndex`, that character becomes visible
- `clamp()` ensures alpha stays between 0 and 1
- `mod(..., 256.0)` makes it loop for long text
